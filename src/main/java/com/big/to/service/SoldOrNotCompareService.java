...
import com.big.to.repository.SoldOrNotCompareDAO;
import com.big.to.vo.TotalIphone;

@Service
public class SoldOrNotCompareService {
	@Autowired(required = false)
	private SoldOrNotCompareDAO dao;
	// 전체 조회
	public ArrayList<TotalIphone> avgPriceList(String krname, String gb, String conditions, 
