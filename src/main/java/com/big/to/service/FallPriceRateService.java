...
import com.big.to.repository.FallPriceRateDAO;
import com.big.to.vo.TotalIphone;

@Service
public class FallPriceRateService {
	@Autowired(required=false)
	private FallPriceRateDAO dao;
	// total_iphone
	public ArrayList<TotalIphone> fallRateList(String krname, String gb, String conditions, 
